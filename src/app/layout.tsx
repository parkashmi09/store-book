...
//   description: "Shop Now on Target Board Store, Get best discounts on books and stationary",
// };
  ...
  return (
    <html lang="en">
      <head>
        ...
        {/* Razorpay Script - Load in head with beforeInteractive */}
        <Script
          id="razorpay-script"
          strategy="beforeInteractive" // Critical for Razorpay
