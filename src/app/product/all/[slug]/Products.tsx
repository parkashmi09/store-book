    ...
    const getProducts = async () => {
        try {
            ...
            if (response.status === 201) {
                ...
                setData(check=="books"?data.categorizedProducts.books:check=="stationery"?data.categorizedProducts.stationery:null)
                setCopyData(check=="books"?data.categorizedProducts.books:check=="stationery"?data.categorizedProducts.stationery:null)
                const mapData =
                    check === "books" ? data.categorizedProducts.books :
                        check === "stationery" ? data.categorizedProducts.stationery :
                            null;
                                       ...
                                       <ul>
                                           ...
                                           <li>
                                               <a>
                                                   ...
                                                   <span className="ml-1 underline">Products</span>
                                               </a>
                                           </li>
                                       </ul>
                                   </div>
                                           ...
                                           filteredData?.map((item:any,key:any)=>(
                                               <Link href={`/product/${item.slug}`} key={key} className="card border hover:border-blue-500 border-gray-300 rounded-xl bg-base-100    transition delay-250">
                                                   ...
                                                   <div className="card-body p-4 pt-2  ">
                                                       <h2 className="text-lg text-center font-semibold truncate max-sm:text-sm">{item.name}</h2>
